...
insert into pictures (id, title, image_url, number, city, rate, description)
values ('1', 'picture1', 'url1', '1111111111', 'saratov', '4', 'description1');
insert into pictures (title, image_url, number, city, rate, description)
values ('picture2', 'url2', '2222222222', 'saratov', '7', 'description2');
insert into pictures (title, image_url, number, city, rate, description)
values ('picture3', 'url3', '3333333333', 'saratov', '2', 'description3');
